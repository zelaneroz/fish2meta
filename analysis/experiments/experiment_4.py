...
file = ROOT / "data/raw/experiment_3_2023-01-27.csv"
with file.open() as f:
    data = f.readlines()
...
#plt.savefig(ROOT / f'results/figures/definite_plots/exp_3/{subject+1}.png')
plt.savefig(ROOT / 'results/figures/definite_plots/median(3-4).png')
plt.show()
print(model)
