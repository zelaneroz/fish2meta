...
for st in stage:
    ...
    x += 5  # space between stages
    if st in ['prism_u','prism_o','after_u', 'after_o']:
...
plt.savefig('media/final_plots/exp_3/5.png')
output=f"""
PCu = {PC_1:.1f}
PCo = {PC_1:.1f}
ACpu = {model[stage[2]][2]:.1f}
ACpo = {model[stage[3]][2]:.1f}
ACu =  {model[stage[4]][2]:.1f}
ACo =  {model[stage[5]][2]:.1f}
"""
print(output)
plt.show()
print(model)

#plt.savefig('media/final_plots/avg.png')
