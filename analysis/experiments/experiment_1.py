...
file = ROOT / "data/raw/experiment_1_2022-11-13.csv"
with file.open() as f:
    data = f.readlines()
...
for x, d in enumerate(data):
    ...
    for v, p in zip(values, exp_data):
        for k, t in x_values.items():
            if x + 1 in t:
                p[k].append(v)
#avg=[-9,-4,-5,-8,-3,-10,-4,-13,6,-10,1,-1,-3,-6,-9,-4,-1,1,-2,0,-3,-9,6,-4,-5,0,-3,-4,-1,-1,-66,-40,-31,-36,-26,-29,-36,-18,-19,-21,-18,-20,-17,-17,-12,-17,-17,-17,-16,-5,-12,-9,-10,-14,-13,-4,-10,-12,-6,-4,-14,-5,-10,-15,-8,-12,-8,-8,-7,-10,2,11,2,6,2,6,0,9,0,-1,-3,3,-1,-4,3,44,35,19,19,10,15,5,7,6,16,3,6,4,10,7]
subject =7
...
for st in stage:
    ...
    if st in ['prism','after_u','after_o']:
        ...
        print(f"{popt[0]:.1f}{'-+'[int(popt[1] > 0)]}{abs(popt[1]):.1f}e(-t/{c_ori:.1f})",)
#
...
for s in models:
    m = model[s]
    xlabel+=f"${m[0]:.1f}{'-+'[int(m[1] > 0)]}{abs(m[1]):.1f}e(-t/{m[2]:.1f})$  "
#
